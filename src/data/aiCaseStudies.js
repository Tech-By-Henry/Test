...
export const aiCaseStudies = [
  ...
  },
  {
    ...
    monogram: 'L',
    accent: '#d94773',
    description: 'A flawless first-pass gym website that translated the brief into a distinctive, complete experience without sacrificing usability on desktop or mobile.',
    cardDescription: 'A perfect 10/10 execution with a strong natural style and no corrections needed on desktop or mobile.',
    ...sharedRequest,
    dateCreated: '18 July 2026',
    status: 'Approved without correction',
    originalPrompt: initialGymPrompt,
    firstOutput: {
      summary: 'Lovable executed the brief cleanly on its first attempt, delivering a complete gym website with a confident identity and a polished experience across screen sizes.',
      resultSummary: 'The typography, imagery, spacing, content hierarchy, interactions, and responsive behaviour work together naturally without feeling generic or over-produced.',
      notes: 'Both desktop and mobile were excellent. The design remained intentional, usable, and visually consistent throughout, so no follow-up correction was necessary.',
      previewUrl: '',
    },
    ...
    finalComparison: {
      ...
      reviewTitle: 'A perfect execution with nothing to correct.',
      review: 'Lovable delivered exactly what the brief needed on the first attempt. The design feels natural and complete, and its quality holds equally well on desktop and mobile without requiring any fixes.',
      strengths: ['Distinctive visual identity', 'Clean and confident desktop execution', 'Equally strong mobile experience'],
      improvements: [],
      fixedProblems: [],
      remainingProblems: [],
      score: 10,
